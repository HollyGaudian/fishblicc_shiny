...
#source("https://github.com/dreamRs/shinyWidgets/blob/26838f9e9ccdc90a47178b45318d110f5812d6e1/R/setSliderColor.R")
...
parameter_data <- reactiveVal(data.frame(peak = numeric(), slope = numeric()))
  ...
  output$plot1 <- renderPlot({
    ...
    #print(paste("peak:", params$peak, "Slope:", params$slope))
